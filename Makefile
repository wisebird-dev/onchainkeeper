...
install: validate-go-version go.sum
	@echo "--> Installing wasmappd"
	@echo "go install -mod=readonly $(BUILD_FLAGS) ./cmd/wasmappd"
	@go install -mod=readonly $(BUILD_FLAGS) ./cmd/wasmappd

build: validate-go-version go.sum
	@echo "--> Build wasmappd"
	@go build -mod=readonly $(BUILD_FLAGS) -o ./build/wasmappd ./cmd/wasmappd
